...
function createAsnow()
{
    ...
    snowDiv.style.display = "fixed";
    
    /* Randomly choose a snow image and assign it to the newly created element */
    image.src = JS_ADMIN_PATH + '/common/templates/snow' + randomInteger(1, 6) + '.png';
    
    snowDiv.style.top = "-100px";

    /* Position the snow at a random location along the screen */
    snowDiv.style.left = pixelValue(randomInteger(0, document.getElementsByTagName("body")[0].offsetWidth));
