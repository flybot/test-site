...
$(document).ready(function() {
	...
	function(reply) {
		...
		$('head').append('<style type="text/css">#fileThumb .thumb img {max-width: '+$cfg.thumbWidth+'px; max-height:'+$cfg.thumbHeight+'px;} #fileThumb .name {max-width: '+$cfg.thumbWidth+'px;}</style>');
